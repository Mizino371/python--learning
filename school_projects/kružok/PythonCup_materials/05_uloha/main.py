...
mesec_img = tkinter.PhotoImage(file="kružok/PythonCup_materials/05_uloha/img/mesec.png")
mince_img = tkinter.PhotoImage(file="kružok/PythonCup_materials/05_uloha/img/minca.png")
