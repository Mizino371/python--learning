...
c.pack()
netrafil = 0
ihrisko_img= tkinter.PhotoImage(file="kružok/PythonCup_materials/06_uloha/img/ihrisko.png")
lopta_img= tkinter.PhotoImage(file="kružok/PythonCup_materials/06_uloha/img/lopta.png")
x_ball=109
y_ball= 177
# ihrisko
...
def program():
    ...
    c.after(500,move_ball(r_move_x,r_move_y))
